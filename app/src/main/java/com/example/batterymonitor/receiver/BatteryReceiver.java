...
public class BatteryReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        TextView statusLabel = ((HomeActivity)context).findViewById(R.id.statusLabel);
        TextView percentageLabel = ((HomeActivity)context).findViewById(R.id.percentageLabel);
        ImageView batteryImage = ((HomeActivity)context).findViewById(R.id.batteryImage);
